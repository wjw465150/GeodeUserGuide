...
<a name="11____管理多个安全用户的RegionServices"></a>
### 管理多个安全用户的RegionServices
...
<a name="16____区域快捷方式和自定义命名区域属性"></a>
### 区域快捷方式和自定义命名区域属性
...
<a name="17____存储和检索区域快捷方式和自定义命名区域属性"></a>
### 存储和检索区域快捷方式和自定义命名区域属性
...
<a name="23____在数据缓存中使用自定义类的要求"></a>
### 在数据缓存中使用自定义类的要求
